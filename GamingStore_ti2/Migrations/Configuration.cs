namespace GamingStore_ti2.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<GamingStore_ti2.Models.JogosDB>
    {
        ...
        protected override void Seed(GamingStore_ti2.Models.JogosDB context)
        {
